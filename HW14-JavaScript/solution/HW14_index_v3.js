...
var countryFilterTerm = $countryDropdown.value;
    ...
    // add the other filters into the filter fnction
...
//the # tells it to stay within the page
    pageLink.setAttribute('href', "#");
    pageItem.appendChild(pageLink);
    $pageList.appendChild(pageItem);
    // console.log('eventlistener param', pageNumber);
// an event listener for each link in the page link list
